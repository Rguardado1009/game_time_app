...
//             <div className="teamButton" id="phillies"/>
//         </div>
//         <div className="teamButton" id="phillies"></div>
//         <button className="teamButton" id="braves"/>
...
export default function National() {
    return (
        ...
        />
        <div className="buttonContainer1">
            <img src="http://assets.stickpng.com/images/58419c6aa6515b1e0ad75a61.png" className="teamButton" id="celtics"/>
